...
extern void unkArmyFunction(int unk0);
extern void unkArmyFunction_0(int control_state, int unk0);
extern void unkArmyFunction_1(int unk0, int unk1, int unk2);
extern void reduceShadowIntensity(int unk0);
extern void animationSomething(void* unk0, int animation);
